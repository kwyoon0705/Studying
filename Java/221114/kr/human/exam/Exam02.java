...
public class Exam02 {
	public static void main(String[] args) {
		...
		int[] revNumlist = new int[numlist.length];
		for (int i = numlist.length - 1, j = 0; i >= 0; i--, j++) {
			revNumlist[j] = numlist[i];
		}
	...
	@Test
	public void test() {
		assertArrayEquals(solution(new int[] { 1, 2, 3, 4, 5, 6 }, 4), new int[] { 4, 5, 3, 6, 2, 1 });
		assertArrayEquals(solution(new int[] { 10000, 20, 36, 47, 40, 6, 10, 7000 }, 30),
