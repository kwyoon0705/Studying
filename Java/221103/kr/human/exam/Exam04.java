...
기존 콜라 문제와 마찬가지로, 보유 중인 빈 병이 a개 미만이면, 추가적으로 
빈 병을 받을 순 없습니다. 상빈이는 열심히 고심했지만, 일반화된 콜라 문제의 
답을 찾을 수 없었습니다. 
...
public class Exam04 {
	public static void main(String[] args) {
        ...
        System.out.println(solution(5, 1, 100));
	}
	@Test
	public void exam01Test() {
		assertEquals(solution(2, 1, 20), 19);
		assertEquals(solution(3, 1, 20), 9);
