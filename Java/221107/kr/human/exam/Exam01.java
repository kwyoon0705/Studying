...
public class Exam01 {
	public static void main(String[] args) {
		...
		String[] answer = new String[str.length / n + 1];
		int j = 0;
	...
	@Test
	public void test() {
		assertArrayEquals(solution("abc1Addfggg4556b", 6), new String[] { "abc1Ad", "dfggg4", "556b" });
		assertArrayEquals(solution("abcdef123", 3), new String[] { "abc", "def", "123" });
	}

	public static String[] solution(String my_str, int n) {
		String[] str = my_str.split("");
		String[] answer = new String[str.length / n + 1];// 배열 각 요소의 null값을 빼줘야함..
		int j = 0;
		for (int i = 0; i < str.length; i++) {
			if (i / n == j) {
				if(answer[j]==null)
